...
map.getView().fit([8352759.007752, 964543.690502, 8789458.647613, 1236239.658526], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PERIYAR WEB GIS</h2>';
        return titleElement;
    })(),
